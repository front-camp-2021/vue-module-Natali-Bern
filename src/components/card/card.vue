<template>
    <div className="products__card">
       <img className="products__image" src="cardData.images[0]" alt="cardData.title">
...
.products__card {
          ...
          .products__item-descriptions {
            ...
            .products-cards__item-description {
              font-size: 12px;
              line-height: 14px;
              font-weight: $font-weight-light;
            }
  
            .products__item-page-link {
          ...
          .products__buttons {
            ...
            .products__wishlist-button {
              align-items: center;
              width: 50%;
              border: none;
              background-color: $button-secondary-color;
              border-bottom-left-radius: 4px;
              background-image: url(/img/wishlist-img.svg);
              background-size: 10%;
              background-repeat: no-repeat;
            ...
            .products__add-to-cart-button {
              ...
              background-image: url(/img/add-to-cart-img.svg);
              background-size: 10%;
              background-repeat: no-repeat;
